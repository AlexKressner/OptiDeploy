...
class Settings:
    ...
    CELERY_WORKER_PREFETCH_MULTIPLIER: float = os.environ.get(
        "CELERY_WORKER_PREFETCH_MULTIPLIER"
    )
    CELERY_ACKS_LATE: str = os.environ.get(
        "CELERY_ACKS_LATE"
    )  # if true mark task as run after task is completed and not before
